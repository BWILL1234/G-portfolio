...
export default function Babanawauniversity() {
  return (
  <main className="min-h-screen bg-[#f5f5f5] font-sans px-4 md:px-10 py-6">
      
      {      /* NAV */}
      <nav className="flex justify-between items-center bg-[#02346D] rounded-2xl px-8 py-6 mb-10 shadow-sm">
        <a
          href="/projects"
  ...
  <p className="mt-8 text-[15px] md:text-[17px] leading-[1.6] text-[#222222]">
    ...
    single platform.
        ...
        <div className="flex flex-col justify-center items-center w-full mt-10 lg:mt-0">
          ...
          <div className="relative w-[105%] max-w-[740px] h-3 md:h-4 bg-[#d4d4d8] rounded-b-2xl shadow-xl border-t border-gray-300 flex justify-center z-20">
...
{/* PROJECT SECTION */}
<section className="py-8 md:px-12 bg-[#-[#02346D] rounded-3xl py-20">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto mb-32">
    ...
    <div className="text-center flex flex-col items-center">
      <div className="text-[#-[#02346D] text-4xl mb-4">◎</div>
  ...
  <div className="max-w-6xl mx-auto text-center py-8">
    ...
    <p className="space-y-6 text-[15px] md:text-[17px] leading-[1.6] text-[#222222]">
      As the UI/UX Designer for Babanawa University, I led the project from initial research 
      to the final high-fidelity prototype, conducting user research and competitive analysis, 
      defining user personas and information architecture, mapping user flows, creating wireframes, 
      designing the user interface, building interactive prototypes, and validating the design to deliver
      a modern, accessible, and user-centered digital experience for prospective students, current students, faculty, and administrative staff.
...
{/* PROCESS SECTION */}
      <section className="py-8 md:px-12 bg-white rounded-3xl mb-20 shadow-sm">
        <div className="max-w-5xl mx-auto text-center">
          ...
          I followed a user-centered design process that allowed every design decision to be based on real student
           needs, behaviors, and expectations. Through research, user interviews, and iterative testing, I identified
            key pain points and opportunities, ensuring that the final solution provides a simple, accessible, and intuitive 
            experience for prospective students, current students, faculty, and staff while improving navigation, information discovery,
             and overall usability across the university platform.
       ...
       <section className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-24 py-8">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="space-y-6 text-[15px] md:text-[17px] leading-[1.6] text-[#222222]">
            <p>
             To understand how students interact with university websites and portals, I interviewed prospective students, current students, and administrative staff.
            </p>
        ...
        <div className="w-full lg:w-1/2 space-y-8 pt-4">
          ...
          <div className="space-y-6 text-[15px] md:text-[17px] leading-[1.6] text-[#222222]">
            <p>
             The participants for this research were primarily between 17 and 30 years old, 
             representing prospective students, undergraduate students, and recent graduates who are
            the primary users of university digital platforms. This audience frequently relies on online systems to explore 
            academic programs, complete admissions processes, register for courses, access campus information, and 
            stay connected with university activities. Their expectations center around speed, simplicity, accessibility,
             and a seamless digital experience.
            </p>
            <p>
              Based on insights gathered from user interviews, affinity mapping, and behavioral patterns identified throughout
              the research process, Amina was developed as the primary user persona for Babanawa University. She represents the 
              goals, challenges, and expectations of students seeking an intuitive platform to apply for admission, explore programs, 
              access academic resources, manage their student information, and stay informed about campus events and announcements.
            </p>
          </div>
        </div>
...
<section className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-12 lg:gap-16 py-8">
        ...
        <div className="w-full lg:w-[45%] space-y-6 pt-4">
          ...
          <div className="space-y-6 text-[15px] md:text-[17px] leading-[1.6] text-[#222222]">
            <p>
             Affinity diagrams helped me organize user insights gathered from interviews and research 
             into meaningful themes and pain points. Through this process, I identified the information 
             prospective and current students need when exploring programs, applying for admission, accessing 
             academic resources, and managing their university experience. I also uncovered common challenges such 
             as navigating complex application processes, finding important information quickly, and staying updated 
             on academic activities.
            </p>
            <p>
             Based on the insights gathered during the empathize phase, I translated key findings into How Might We 
             (HMW) questions. These questions transformed user frustrations into design opportunities and guided the 
             creation of solutions that balance student needs with Babanawa University's digital transformation goals.
            </p>
            <p>
             By framing these challenges as How Might We questions, I was able to focus on designing a 
             more intuitive, accessible, and student-centered university platform.
            </p>
            
            <ul className="list-disc pl-5 space-y-2 pt-2">
              <li>How might we make it easier for prospective students to discover programs and admission requirements?</li>
              <li>How might we simplify the application and enrollment process from start to finish?</li>
              <li>How might we help students access academic resources, schedules, and announcements from one place?</li>
              <li>How might we improve communication between students, lecturers, and university departments?</li>
              <li>How might we provide real-time updates on applications, registrations, and academic activities?</li>
              <li>How might we reduce confusion and errors when completing admissions, course registration, or fee payments?</li>
              <li>How might we create a university experience that is modern, reliable, and easy to use for every student?</li>
            </ul>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 space-y-8 lg:pr-8 pt-4">
          <div className="space-y-4">
           <h1 className="text-4xl md:text-5xl lg:text-[56px] font-normal text-[#111111] tracking-tight shrink-0 md:min-w-[200px] lg:min-w-[250px]">
            ...
            <p className="text-[17px] md:text-[17px] leading-[1.6] text-[#222222]">
             After validating the low-fidelity wireframes, I transformed the concepts into interactive high-fidelity 
             designs in Figma, focusing on creating a seamless experience for prospective students, current students, and university administrators.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl lg:text-[32px] font-normal text-[#111111] tracking-tight shrink-0 md:min-w-[200px] lg:min-w-[250px]">
              Improvement #1: Admission & Program Discovery
            </h1>
            ...
            <ol className="list-decimal pl-5 space-y-4 text-[15px] md:text-[17px] text-[#222222] font-medium marker:font-medium">
              <li className="pl-1">
                ...
                <ol className="list-[lower-alpha] pl-6 pt-2 space-y-1 font-normal">
                  <li>Browse programs by faculty or department.</li>
                  <li>Search for courses and academic information quickly.</li>
                  <li>View admission requirements, tuition fees, and program details.</li>
                  <li>Receive recommendations based on interests and career goals.</li>
                </ol>
              </li>
              <li className="pl-1">
                Admission Transparency
                <ol className="list-[lower-alpha] pl-6 pt-2 space-y-1 font-normal">
                  <li>Display application requirements before starting the process.</li>
                  <li>Show application deadlines and admission status updates.</li>
                  <li>Notify applicants of missing documents or important changes.</li>
                  <li>Clearly indicate eligibility criteria and the next steps, helping students 
                      complete their applications with confidence.</li>
                </ol>
              </li>
            </ol>
          </div>
      ...
      <section className="max-w-[1400px] mx-auto w-full py-8">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-[44px] font-normal text-[#111111] tracking-tight mb-12 lg:mb-20">
          Improvement #2: Admission & Student Portal Flow
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center lg:items-start">
          ...
          <div className="w-full lg:w-[45%] text-[17px] md:text-[21px] text-[#222222] leading-[1.6]">
            <p className="mb-6">
             In this improvement, I combined two essential user flows to create a more seamless university experience:
            </p>
            
            <ol className="list-decimal pl-6 space-y-6 md:space-y-8">
              <li className="pl-2">
                Guiding prospective students through the admission process, from exploring programs to submitting applications.
              </li>
              <li className="pl-2">
                Providing real-time application updates, document verification, fee payments, and enrollment confirmation without requiring users to leave the platform.
                </li>
                <p className="mb-6">
             This streamlined flow enables applicants to track their admission status, receive important notifications, upload required documents, and complete enrollment steps in one place. By centralizing communication and academic onboarding within the Babanawa University platform, the experience becomes more transparent, efficient, and convenient for both students and university administrators.
            </p>
            </ol>
          </div>
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-end">
          ...
          <div className="space-y-16">
            ...
            <div>
              ...
              The final design delivered a more intuitive and student-centered university experience. During usability 
              testing, participants were able to complete key tasks—such as exploring programs, applying for admission,
               tracking application status, registering for courses, and accessing academic resources—more quickly and with
                greater confidence.

                Users particularly appreciated the simplified admission process, clear navigation, and centralized student dashboard, which made it easy to manage academic activities from a single platform. They also valued the transparent application flow, real-time status updates, and organized access to course information, schedules, fee payments, and university announcements, reducing confusion throughout their academic journey.

Overall, the design improved accessibility, streamlined the student experience, and received positive feedback for its simplicity, clarity, and ease of use.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-xl leading-relaxed text-gray-900">
                <p>
                 Given more time, I would further refine the end-to-end student experience by improving error handling, 
                 simplifying course registration and fee payment flows, and enhancing communication between students, 
                 lecturers, and university departments.
                </p>

                <p>
                 I would also conduct larger-scale user research using quantitative data and usability testing across a 
                 broader range of prospective and current students to validate design decisions and identify additional opportunities
                  for improvement. Future iterations would explore features such as personalized academic recommendations, integrated 
                  campus event management, real-time chat support, digital document requests, and alumni services to create a more 
                  comprehensive and connected university ecosystem.
                </p>
              </div>
            </div>
          </div>
